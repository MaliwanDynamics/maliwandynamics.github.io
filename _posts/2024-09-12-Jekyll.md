...
- software
---
Apart from the occasional GitHub-er or fanboy, I feel that not many people talk about [Jekyll](https://jekyllrb.com/) anymore. It can be useful for setting up a custom static website as fast as possible.

If you need a more complex application, especially one that is not static, Jekyll is probably not the best option. That said, you will need some HTML, CSS, and possibly JavaScript knowledge depending on what you are trying to achieve.
