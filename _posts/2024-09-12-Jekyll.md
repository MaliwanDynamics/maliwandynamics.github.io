...
Here is a simplified example with a home page and a loop for displaying eaxh posts with a link. This example does not use and themes or templates to make it easier to play around wih and understand.

You can checkout the full project on [Github](https://github.com/maliwandynamics/testsite).
